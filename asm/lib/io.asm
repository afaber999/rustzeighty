...
blk_dev_init:       equ 0xF0

blk_dev_rd_blk:     equ 0xF1
blk_dev_rd_char:    equ 0xF1
blk_dev_wr_char:    equ 0xF2
blk_dev_wr_blk:     equ 0xF3

blk_dev_blk_b3:     equ 0xFC
blk_dev_blk_b2:     equ 0xFD
blk_dev_blk_b1:     equ 0xFE
blk_dev_blk_b0:     equ 0xFF
